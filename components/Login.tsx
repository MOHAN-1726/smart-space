...
const Login: React.FC = () => {
  ...
  const inputClasses = "mt-1 block w-full px-3 py-2 bg-white dark:bg-slate-700 border border-slate-300 dark:border-slate-600 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 dark:focus:ring-primary-500 dark:focus:ring-offset-slate-900 transition-all duration-200";
          ...
          <Card key="login" className="!bg-white/80 dark:!bg-slate-800/60 !rounded-2xl">
            <form onSubmit={handleLoginSubmit}>
              ...
              <div className="text-right mb-6">
                <button type="button" onClick={() => setView('forgotPassword')} className="text-sm font-semibold text-primary-600 hover:text-primary-500 dark:text-primary-400 dark:hover:text-primary-300 transition-colors">
                  Forgot password?
                </button>
              </div>
            ...
            <p className="mt-6 text-center text-sm text-slate-600 dark:text-slate-400">
              ...
              <button onClick={() => { setView('register'); setLoginError(''); }} className="font-semibold text-primary-600 hover:text-primary-500 dark:text-primary-400 dark:hover:text-primary-300 transition-colors">
                Register
              </button>
            </p>
          </Card>
        ...
        return (
          <Card key="register" className="!bg-white/80 dark:!bg-slate-800/60 !rounded-2xl">
            ...
            <p className="mt-6 text-center text-sm text-slate-600 dark:text-slate-400">
              ...
              <button onClick={() => { setView('login'); setRegError(''); }} className="font-semibold text-primary-600 hover:text-primary-500 dark:text-primary-400 dark:hover:text-primary-300 transition-colors">
                Sign In
              </button>
            </p>
          </Card>
        ...
        return (
          <Card key="forgot" className="!bg-white/80 dark:!bg-slate-800/60 !rounded-2xl">
            ...
            <p className="mt-6 text-center text-sm text-slate-600 dark:text-slate-400">
              ...
              <button onClick={() => { setView('login'); setForgotError(''); }} className="font-semibold text-primary-600 hover:text-primary-500 dark:text-primary-400 dark:hover:text-primary-300 transition-colors">
                Sign In
              </button>
            </p>
          </Card>
    ...
    <div className="min-h-screen flex items-center justify-center bg-blue-50 dark:bg-transparent p-4">
      <div className="max-w-md w-full animate-slideInUp">
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold gradient-text">Student Activity Portal</h1>
